...
export const quizV1Questions = {
  welcome: {
    title: 'Boas-vindas',
    text: 'Olá! Sou Lorena Carvalho, advogada especialista em Direito Aéreo. Em menos de 1 minutos, vou analisar se você tem direito a uma indenização pelo que aconteceu no seu voo. Vamos começar?',
  },
  passo_1_intencao: {
